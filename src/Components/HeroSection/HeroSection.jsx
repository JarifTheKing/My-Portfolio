      ...
      <div className="relative z-10 container mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-20">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-6 justify-center md:justify-start">
            <motion.a
              href="https://drive.google.com/file/d/1k7z4MwGek0xRZCslEsWcKN9JQ1libuwi/view?usp=sharing"
              target="_blank"
            ...
            <motion.a
              href="https://drive.google.com/file/d/1_nIuAFR8E6kEvv8vDfg0RBHFwQ3ly973/view?usp=sharing"
              target="_blank"
              className="relative inline-block rounded-lg overflow-hidden px-0 py-0"
              whileHover={{ scale: 1.05 }}
            >
              <div className="bg-gradient-to-r from-purple-700 to-purple-900 p-[2px] rounded-lg h-full">
                <div className="bg-gray-800 rounded-lg px-6 py-3 text-purple-500 font-semibold text-center flex items-center justify-center gap-2">
                  <PiCertificateFill className="text-xl" /> View Certificate
                </div>
              </div>
            </motion.a>
          </div>
